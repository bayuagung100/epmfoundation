...
if(!empty($_POST["id"])){
    ...
    $query = $mysqli->query("SELECT COUNT(*) as num_rows FROM program WHERE id < ".$_POST['id']." AND kategori='$_POST[name]' ORDER BY id DESC");
    ...
    $pquery = $mysqli->query("SELECT * FROM program WHERE kategori='$_POST[name]' AND id < ".$_POST['id']." ORDER BY id DESC LIMIT $showLimit");
    $jml = $pquery->num_rows;
