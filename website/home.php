			...
			<div class="col-md-4">
				<div class="causes">
					...
					<div class="causes-progress">
						<div>
							<span class="causes-raised">Kategori: </span>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="cta-content visi">
								<h3>Visi</h3>
								<p class="lead">Visi kita adalah...Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
							</div>
						</div>
						<div class="col-md-6">
							<div class="cta-content misi">
								<h3>Misi</h3>
								<p class="lead">Misi kita adalah...Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
							</div>
						</div>
					</div>
				</div>
